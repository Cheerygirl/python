...
#                break
            if((ChainBalance['dpabs'].iloc[dateindex+1]>0)
                ...
                ChainBill.cycle[(ChainBill['bill_time']==BillDate) & (ChainBill[uuid]==i)] = ChainBalance['by_date'].iloc[dateindex+1]
                break
    CycleData = CycleData.append(ChainBill)

CycleData.to_csv('e:/code/python/cycledata.csv',encoding='utf-8')
